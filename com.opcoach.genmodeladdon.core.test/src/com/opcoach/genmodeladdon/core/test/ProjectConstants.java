...
{
	public static final String SRC_SAMPLE_PROJECT = "com.opcoach.genmodeladdon.sample";
	public static final String DEST_SAMPLE_PROJECT = "com.opcoach.genmodeladdon.destsample";
